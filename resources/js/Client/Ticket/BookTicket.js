  ...
  const steps = [
    {
      title: 'Chọn vé',
      content: <>
        <SelectTicket ticketInfor={ticketInfor} setTicketInfor={setTicketInfor} setTotal={setTotal} price={price} />
    ...
    {
      title: 'Xác nhận',
      content: <OrderForm ticketInfor={ticketInfor} setTicketInfor={setTicketInfor} total={total} setSeat={setSeat} setCurrent={setCurrent} setOrderId={setOrderId} />,
    },
    {
      title: 'Đặt vé thành công',
      content: <ResultOrder orderId={orderId} />,
    },
  ];
              ...
              <Col span={18}>
                ...
                <div className="steps-action">
                  ...
                  {current < steps.length - 1 && (
                    <Button type="primary" onClick={() => next()} disabled={current == 2 && orderId == "" ? true : false}>
                      Tiếp
                    </Button>
                  )}
                  {/* {current === steps.length - 1 && (
